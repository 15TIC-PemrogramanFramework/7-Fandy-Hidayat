	...
	<div class="header-top">
		...
		<div class="container">
			...
			<div class="w3layouts-details">
				<ul>
					<li><a href="mailto:qe.services@qes.co.id"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>qe.services@qes.co.id</a></li>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<?php echo menu();?>
							<li class="login w3"><a href="loginmember">Login</a></li>
						</ul>	
						<div class="clearfix"> </div>
					</div>	
				</nav>	
